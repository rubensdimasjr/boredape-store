      ...
      <div class="container">
        <div class="row mt-5">
          <div class="col-md-12 col-lg-6 mb-4">
            <img src="../assets/images/contact_us.svg" class="img-fluid" alt="Contact Us">
          </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row g-2 mb-3">
                    ...
                    <div class="col">
                      ...
                      <input type="text" class="form-control" name="celular" id="celular" placeholder="(XX)X XXXX-XXXX">  
                    </div>
                  </div>
                  <div class="mb-3">
                    <label for="assunto" class="form-label">Assunto: </label>
                    <textarea class="form-control" rows="4" name="assunto"></textarea>
                  </div>
